            ...
            <!-- section add student -->
                <div class="student-form my-5">
                    <h3 class="title fs-6 fw-light">
                        Veuillez remplir tous les champs du formulaire pour ajouter un nouveau élève
                    </h3>
                        ...
                        if(isset($_POST['ajouter'])){
                            ...
                            if(isset($_POST['nom']) AND !empty($_POST['nom'])
                              ...
                              AND isset($_POST['date_de_naissance']) AND !empty($_POST['date_de_naissance'])
                                ...
                                $addStudent->execute([$nom, $prenom, $date_de_naissance]);
                                $success_messages[] = "L'élève a été bien ajouté avec success!";
                    ...
                    <div class="form-wrapper">
                        <form action="" method="post" class="form-group">
                            ...
                            <div class="send d-flex justify-content-end mt-5">
                                <button type="submit" name="ajouter" href="" class="btn btn-dark">Ajouter</button>
                            </div>
                        </form>
                    </div>
