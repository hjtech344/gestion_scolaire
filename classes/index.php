        ...
        <div class="main-content position-relative w-100">
            ...
            <!-- section add student -->
                <div class="add-student d-flex justify-content-between mt-5 mb-4">
                    <h3 class="title">Listes des classes</h3>
                    <div>
                       <a class="btn-add" href="ajouter.php">Add classroom</a>
                    </div>
                </div>
            ...
            <!-- Table List student's -->
                <div class="table-recent-register heigth overflow-auto">
                    <div class="add-student d-flex justify-content-between mb-2">
                        <h3 class="main-title">Listes des classes</h3>
                                    ...
                                    if($classes->rowCount() > 0){
                                               ...
                                               <td><?= $classe_nom ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-4 justify-content-center">
                                                        ...
                                                        >
                                                           <a href="./modifier.php?edit=<?= $classe_id ?>"><i class="fa-solid fa-pencil text-success"></i></a> 
                                                        </div>
                                            
                                                        <div class="trash bg-danger-subtle d-flex 
                                                           align-items-center justify-content-center rounded-circle"
                                                        >
                                                            <input class="classe_id" type="hidden" value="<?= $classe_id ?>">
                                                            <a href="javascript:void(0)">
                                                                <i class="btn-destroy-classe-ajax fa-solid fa-trash text-danger"></i>
                                                            </a> 
                                                        </div> 
                                                    </div>
                                                </td>
                                        ...
                                        ?>
                                            <span class="py-4 text-secondary fs-5 fw-semibold">
                                             Il n'y a pas de classe pour le moment !
                                            </span>
                                        <?php
                                    }
                                ?>
